...
const template5 = compiler.compile('<img v-for="(item,index) in list" :src="item.url" alt="" @click="selctedItem">');
console.log(template5.render);//with(this){return _l((list),function(item,index){return _c('img',{attrs:{"src":item.url,"alt":""},on:{"click":selctedItem}})})}
